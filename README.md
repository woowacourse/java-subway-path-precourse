...
- [x] 경로 조회 기능
    - [x] 출발역과 도착역을 입력받아 경로를 조회한다.
        - [x] 예외. 출역과 도착역이 같으면 예외가 발생한다.
        - [x] 예외. 출발역과 도착역이 연결되어 있지 않으면 예외가 발생한다.
    - [x] 경로 조회 기준은 '최단 거리', '최소 시간' 하나를 선택할 수 있다.
...
- [x] 경로 조회 시 경로 기준을 선택하는 메뉴를 출력한다.
    - [x] 예외. 경로 조회나 종료의 명령어가 아닌 값을 입력받으면 예외가 발생한다.
    - [x] 돌아가기를 누르면 메인메뉴가 다시 실행된다. 
