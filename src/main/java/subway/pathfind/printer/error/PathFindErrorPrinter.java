...
public class PathFindErrorPrinter {
    ...
    private static final String PATH_NOT_EXISTS_ERROR_MESSAGE
        = "\n" + CommonPrinter.ERROR_PREFIX + "두 역은 연결되어있지 않습니다.";
    ...
    public static void printPathNotExistsErrorMessage() {
        System.out.println(PATH_NOT_EXISTS_ERROR_MESSAGE);
    }
}
