...
public class OutputView {
    ...
    public static final String ORDER_TO_INPUT_ARRIVAL_STATION = "## 도착역을 입력하세요.";
    
    public static void print(String message) {
        System.out.println(message);
    }

    public static void printDistanceList(Result result, Station arrivalStation, List<Station> stops, int distance){
        System.out.println("## 조회 결과");
        System.out.println(SEPARATOR_LINE);
        System.out.println(INFO+TOTAL_DISTANCE+distance+KM);
        System.out.println(SEPARATOR_LINE);
        stops.stream()
            .forEach(stop-> System.out.println(INFO+stop));
        System.out.println();
    }

    public static void printTimeList(Result result, Station arrivalStation, List<Station> stops, int distance){
        System.out.println("## 조회 결과");
        System.out.println(SEPARATOR_LINE);
        System.out.println(INFO+TOTAL_TIME+distance+MIN);
        System.out.println(SEPARATOR_LINE);
        stops.stream()
            .forEach(stop-> System.out.println(INFO+stop));
        System.out.println();
