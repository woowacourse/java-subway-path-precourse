...
public class OutputView {
    ...
    private static final String TOTAL_LENGTH = "총 거리: %.0fkm\n";
    ...
    public static void printResult(PathDTO pathDTO) {
        ...
        System.out.printf(INFO_PREFIX + TOTAL_LENGTH, pathDTO.getDistance());
        System.out.printf(INFO_PREFIX + TOTAL_TIME, pathDTO.getTime());
        System.out.println(INFO_PREFIX + BAR);
