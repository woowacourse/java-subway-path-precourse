...
public class ShortestDistancePathActionScreen extends BaseActionScreen {
    ...
    public ShortestDistancePathActionScreen(CategoryType selectedCategoryType) {
    ...
    protected void action(InputView inputView) {
        ...
        OutputView.printResult(TOTAL_DISTANCE_MESSAGE + DOT_DOT + responseDto.getTotalWeight() + KILLOMETER_MESSAGE);
        OutputView.printResult(COLUMN_LINE);
