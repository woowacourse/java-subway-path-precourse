...
public class LineRepository {
    ...
    public static void lineInitialization() {
        ...
        secondLine.setLineDistances(new ArrayList<DistanceAndTime>(Arrays.asList(new DistanceAndTime(교대에서_강남_거리, 교대에서_강남_시간), new DistanceAndTime(강남에서_역삼_거리, 강남에서_역삼_시간))));
        ...
        thirdLine.setLineDistances(new ArrayList<DistanceAndTime>(Arrays.asList(new DistanceAndTime(교대에서_남부터미널_거리, 교대에서_남부터미널_시간), new DistanceAndTime(남부터미널에서_양재_거리, 남부터미널에서_양재_시간), new DistanceAndTime(양재에서_매봉_거리, 양재에서_매봉_시간))));
        ...
        newBundangLine.setLineDistances(new ArrayList<DistanceAndTime>(Arrays.asList(new DistanceAndTime(강남에서_양재_거리, 강남에서_양재_시간), new DistanceAndTime(양재에서_양재시민의숲_거리, 양재에서_양재시민의숲_시간))));
