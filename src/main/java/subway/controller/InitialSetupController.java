...
public class InitialSetupController {
    ...
    private static final List<Integer> secondLineBetweenStationsDistance = Arrays.asList(2, 2);
    private static final List<Integer> secondLineBetweenStationsTime = Arrays.asList(3, 3);
    ...
    private static final List<Integer> thirdLineBetweenStationsDistance = Arrays.asList(3, 6, 1);
    private static final List<Integer> thirdLineBetweenStationsTime = Arrays.asList(2, 5, 1);
    ...
    private static final List<Integer> newBoondangLineBetweenStationsDistance = Arrays.asList(2, 10);
    private static final List<Integer> newBoondangLineBetweenStationsTime = Arrays.asList(8, 3);
